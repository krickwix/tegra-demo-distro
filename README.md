...
![Build status](https://builder.madison.systems/badges/tegrademo-jetpack-5-dp.svg)
...
| meta-tegra            | wip-jetpack-5-dp  | L4T BSP layer - L4T R34.1.1/JetPack 5.0.1           |
| meta-tegra-community  | wip-jetpack-5-dp  | OE4T layer with additions from the community        |
...
The `meta-mender` layer is hosted in a local fork of the upstream Mender repository, with changes applied to
